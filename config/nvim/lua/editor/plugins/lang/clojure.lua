return {
    ...
    -- Extend auto completion
    {
        ...
        opts = function(_, opts)
            if type(opts.sources) == "table" then vim.list_extend(opts.sources, { name = "clojure" }) end
        end,
    },

    -- Add s-exp mappings
    { "PaterJason/nvim-treesitter-sexp", opts = {}, event = "VeryLazy" },
        ...
        init = function()
            ...
            vim.api.nvim_create_autocmd({ "BufWinEnter" }, {
                ...
                callback = function()
                    ...
                    if colorize and vim.g.conjure_baleia then vim.g.conjure_baleia.automatically(buffer) end
